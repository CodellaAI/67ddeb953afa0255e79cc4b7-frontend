...
export default function PostCard({ post }) {
  ...
  return (
    <div className="card hover:border hover:border-gray-300">
      {/* Vote buttons */}
      <div className="flex">
        ...
        <div className="p-3 flex-1">
          ...
          {post.image && (
            <div className="mb-3 relative w-full max-h-96 overflow-hidden">
              <Image 
                src={post.image} 
                alt={post.title}
                width={800}
          ...
          <div className="flex items-center text-xs text-gray-500 pt-1">
            <Link 
              href={`/r/${post.community}/${post._id}`} 
              className="flex items-center p-1 mr-4 hover:bg-gray-100 rounded"
            >
